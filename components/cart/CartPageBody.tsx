          ...
          <>
            ...
            <div className="flex flex-col lg:hidden gap-5">
              ...
              <div
                ...
                style={{ width: "375px", maxWidth: "100%", gap: "15px" }}
              >
                {/* Promo code strip */}
                <button
                  type="button"
            ...
            <div className="hidden lg:flex flex-row gap-8 items-start">
              ...
              <div className="flex-[39]">
                ...
                >
                  ...
                  <button
                    type="button"
                    className="font-label font-bold text-accent-cyan-muted hover:opacity-80 transition-opacity duration-150 flex items-center justify-start w-full"
                    style={{
                      fontSize: "12px",
                      height: "50px",
                      border: "1px solid #2D2D2D",
