...
export default function ProductDisplay({ variantId, available, surface }: ProductDisplayProps) {
  ...
  return (
    <div className="w-full px-5 lg:px-0 flex flex-col lg:flex-row items-start justify-center gap-6 lg:gap-[50px]">
      {/* Left: image gallery */}
<div
  className="flex flex-col items-start w-full lg:w-[700px] lg:flex-shrink-0 lg:sticky lg:self-start lg:top-[100px]"
  style={{ gap: "20px" }}
>
      ...
      {/* Right: product info */}
      <div
        className="w-full lg:w-[700px] lg:flex-shrink-0 min-w-0 flex flex-col items-stretch gap-6 lg:gap-[30px]"
      >
