...
export default function TechHero() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center lg:items-start lg:text-left justify-center gap-6 px-[20px] py-16 lg:py-24 lg:pl-container lg:pr-16 lg:max-w-[600px]">
