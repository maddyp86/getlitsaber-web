  ...
  return (
    ...
    >
      ...
      <div className="w-full px-[20px] lg:pl-[60px] lg:pr-0">
        <div className="flex flex-col py-16 lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(440px,50%)] lg:items-end lg:gap-x-10 lg:pt-[50px] lg:pb-0">
          ...
          <div className="flex flex-col justify-center gap-6 max-w-[800px] lg:self-center lg:pb-16">
            ...
            <motion.h1
              ...
              style={{ fontSize: "clamp(45px, 7vw, 90px)" }}
