  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-content px-content">
        ...
        <motion.p
          className="font-body text-body-sm lg:text-body text-text-secondary leading-relaxed mb-12 max-w-[640px]"
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:gap-16">
          ...
          <div className="flex-1 min-w-0">
            <motion.p
              className="font-label text-eyebrow tracking-[0.15em] uppercase text-text-muted mb-6"
                ...
                >
                  <div className="flex flex-col gap-2 w-full">
                    ...
                    <div className="flex items-baseline gap-3">
                      <span className="font-label text-eyebrow tracking-[0.1em] text-accent-cyan shrink-0">
                        {step.num}
                      </span>
                      <span className="font-label text-label tracking-[0.15em] uppercase text-text-primary font-bold">
                        {step.label}
                      </span>
                    </div>
                    {/* Step body */}
