...
import { SECTION_IDS, ACTIVATE_QUICKSTART } from "./activate.content";
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-content px-content">
        ...
        <motion.h2
          className="font-display text-center font-bold uppercase text-white mb-2"
        ...
        <motion.p
          className="font-body text-center text-body-sm lg:text-body text-text-secondary mb-16 max-w-[600px] mx-auto"
