...
const VIDEOS: TikTokVideo[] = [
  {
    url: "https://www.tiktok.com/@getlitsaber/video/7578956594189274399",
    caption: "",
    views: "",
  },
  {
    url: "https://www.tiktok.com/@getlitsaber/video/7561515341424135454",
    caption: "",
    views: "",
  },
  {
    url: "https://www.tiktok.com/@getlitsaber/video/7599752282464455967",
    caption: "",
    views: "",
  },
  {
    url: "https://www.tiktok.com/@getlitsaber/video/7581564990033890590",
    caption: "",
    views: "",
  },
  {
    url: "https://www.tiktok.com/@getlitsaber/video/7630952753501703455",
    caption: "",
    views: "",
  },
  {
    url: "https://www.tiktok.com/@getlitsaber/video/7613414053091839262",
    caption: "",
    views: "",
  },
];
...
export default function WhatCustomersSay() {
  ...
  return (
    ...
    >
      ...
      {/* Lightbox */}
      {activeId && (
        <Lightbox id={activeId} onClose={close} />
      )}
    </section>
  );
}
