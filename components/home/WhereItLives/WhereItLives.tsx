  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Headline */}
        <motion.h2
          className="font-display font-bold text-text-primary uppercase whitespace-pre-line mb-6"
        ...
        <motion.p
          ...
          style={{ fontSize: "clamp(15px, 1.4vw, 20px)", maxWidth: "350px", lineHeight: "1.6" }}
