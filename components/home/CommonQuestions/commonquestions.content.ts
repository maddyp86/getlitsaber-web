...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. Universal 510 thread fits any standard cart from 10.5mm to 14.5mm — distillate, live resin, rosin, cured resin. Three-voltage tuning (2.4V, 2.8V, 3.2V) lets you match the voltage to your oil.",
  },
  {
    number: "/ 03",
    question: "How long does the battery last?",
    answer:
      "800mAh cobalt cell handles a full festival night on one charge. USB-C tops up in under 75 minutes. Rated for 300+ recharge cycles — about a year of regular use.",
  },
  {
    number: "/ 04",
    question: "How visible are the lights at a festival?",
    answer:
      "Bright enough to spot across a dance floor. The 41-LED array runs the full length of the device, diffused through a polycarbonate body — the whole device glows, not just an indicator. You'll see them. Your friends will see them.",
  },
  {
    number: "/ 05",
