...
<p
  ...
  position: "absolute"
        ...
        <div class="absolute" style="display:flex;flex-direction:column;align-items:center;width:auto;max-width:1250px;left:50%;transform:translateX(-50%);top:150px;gap:100px;z-index:10">
