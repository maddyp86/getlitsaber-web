...
export default function ThreeModesDesktop({ className }: ThreeModesDesktopProps) {
  ...
  return (
    ...
    >
      {/* ── TOP BAND ────────────────────────────────────────────────────── */}
     <div className="relative w-full overflow-hidden" style={{ minHeight: "1200px", paddingTop: "80px", paddingBottom: "50px",maxWidth: "100vw" }}>
...
<div style={{ display: "flex", width: "100%", gap: "50px", alignItems: "center", justifyContent: "center" }}>
  ...
  {/* Left — mode cards: stretch to equal thirds of 700 to eat the gap space */}
