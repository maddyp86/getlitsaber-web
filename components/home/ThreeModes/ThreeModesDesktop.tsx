...
export default function ThreeModesDesktop({ className }: ThreeModesDesktopProps) {
  ...
  return (
    ...
    >
      {/* ── TOP BAND ────────────────────────────────────────────────────── */}
     <div className="relative w-full overflow-hidden" style={{ minHeight: "1100px", paddingTop: "80px", paddingBottom: "50px",maxWidth: "100vw" }}>
        ...
        INTERACTIVE LIGHTS
              ...
              <div>
                <span
                  ...
                  style={{ fontSize: "75px", lineHeight: "80px" }}
                >
                  TEN WAYS TO
                </span>
                <span
                  className="font-accent text-accent-cyan block"
                  style={{ fontSize: "75px", lineHeight: "80px", fontWeight: 400 }}
                >
                  BE SEEN
                </span>
              </div>
...
{/* Left — mode cards */}
  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: "20px", flex: "1 0 0", height: "650px" }}>
