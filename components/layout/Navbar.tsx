...
<div className="mx-auto w-full max-w-content h-full px-content flex items-center">
          ...
          <div className="flex items-center justify-end gap-1 lg:w-40">
            ...
            <button
              aria-label="Account"
              className="hidden lg:flex items-center justify-center w-10 h-10 text-text-secondary hover:text-accent-cyan transition-colors duration-200"
            >
              <UserIcon />
            </button>
...
function CartIcon() {
  return (
    <svg width="22" height="24" viewBox="0 0 28 32" fill="none" aria-hidden="true">
      <path
