  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(0,0,0,0.00) 0%, rgba(0,0,0,0.50) 47.5%), url(/images/home/litsaber-festival.jpg) lightgray 50% / cover no-repeat",
        }}
        aria-hidden="true"
      />
      {/* Mobile */}
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-container-mobile lg:px-container py-20 lg:py-24 gap-6">
        <h2
          className="font-subhead font-black uppercase text-white leading-none"
          style={{
