    ...
    >
      ...
      <div className="mx-auto w-full max-w-[1250px] px-[20px] lg:px-[60px] py-[100px]">
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-16">
          ...
          <motion.div
            className="mt-10 lg:mt-0 w-full max-w-[420px] mx-auto lg:mx-0 lg:w-[420px] lg:flex-shrink-0 aspect-[9/16] rounded-card overflow-hidden bg-surface-card border border-border-pill"
