...
export default function RetailKit() {
  ...
  return (
    <section
      className="relative isolate w-full bg-[linear-gradient(180deg,#150C2D_0%,#000_110%)]"
    ...
    >
      ...
      <div className="mx-auto w-full max-w-content px-content py-section-y-mobile lg:py-section-y">
       ...
       <motion.div
  className="relative w-full max-w-[400px] mx-auto lg:mx-0 lg:w-[400px] lg:flex-shrink-0 lg:sticky lg:top-[120px] lg:self-start aspect-[3/4] rounded-card overflow-hidden"
