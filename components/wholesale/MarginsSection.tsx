...
<div
  className="absolute pointer-events-none -z-10 bottom-[400px] lg:top-0"
...
>
  ...
  />
      ...
      <div className="mx-auto w-full max-w-[1250px] px-[20px] lg:px-[60px] pt-[100px] lg:pb-[200px] pb-[150px]">
